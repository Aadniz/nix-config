...
in
{
  ...
  boot.initrd.network = {
    ...
    ssh = {
      ...
      authorizedKeys = [
        ...
        "ssh-rsa  pi@raspberrypi"
      ];
  ...
  fileSystems = genFsConfig bigDisk // genFsConfig disk500;
